...
public:
    virtual void OnCheckInstanceCount(Player* /*player*/, uint32 /*defaultCount*/, uint32& /*newCount*/)
    {
    }

    virtual void OnGetSkillCount(Player* /*player*/, uint32 /*defaultCount*/, uint32& /*newCount*/)
    {
    }

    virtual void OnVipLevelChanged(Player* /*player*/, uint32 /*level*/, uint32 /*old_level*/)
    {
    }

    virtual void GetVipLevel(Player* /*player*/,uint32& /*level*/)
    {
    }

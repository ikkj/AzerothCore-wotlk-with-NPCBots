...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    // End NPCBot
    // Player NPCBot
    CHAR_INS_PLAYER_NPCBOT,
    CHAR_UPD_PLAYER_NPCBOT_OWNER,
    CHAR_DEL_PLAYER_NPCBOT_TRANSMOG,
    CHAR_UPD_PLAYER_NPCBOT_ROLES,
    CHAR_UPD_PLAYER_NPCBOT_SPEC,
    CHAR_UPD_PLAYER_NPCBOT_FACTION,
    CHAR_UPD_PLAYER_NPCBOT_DISABLED_SPELLS,
    CHAR_UPD_PLAYER_NPCBOT_EQUIP,
    CHAR_DEL_PLAYER_NPCBOT,
    CHAR_UPD_PLAYER_NPCBOT_OWNER_ALL,
    CHAR_DEL_PLAYER_NPCBOT_TRANSMOG_ALL,
    CHAR_REP_PLAYER_NPCBOT_STATS,
    CHAR_REP_PLAYER_NPCBOT_TRANSMOG,
